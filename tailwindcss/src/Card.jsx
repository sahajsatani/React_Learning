function Card({user="temp",stock="out of stock"}) {
  console.log(user);
  return (
    <>
      <div className="flex font-sans mb-3">
        ...
        <form className="flex-auto p-6">
          <div className="flex flex-wrap">
            <h1 className="flex-auto font-medium text-slate-900">{user}</h1>
            <div className="w-full flex-none mt-2 order-1 text-3xl font-bold text-violet-600">
              $39.00
            </div>
            <div className="text-sm font-medium text-slate-400">{stock}</div>
          </div>
